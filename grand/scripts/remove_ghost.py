...
from grand.utils import backup_if_exist_gmx, load_top

def main():
    parser = argparse.ArgumentParser(description=
                 f"""Omdrun {grand.__version__}. This script can shift the ghost water out side the simulation box, and
    ...
    print(f"grand Version: {grand.__version__}")
